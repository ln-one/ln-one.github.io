Personal standards for research and writing.

1. **Fraud will be exposed. Without credibility, nothing remains.**
2. AI is a tool. Own the work and the choices. Accept full responsibility and be prepared to bear every consequence.
3. Do not pursue zoo-style metaheuristic optimization algorithms. This means wrapping familiar search operators in animal-behavior metaphors, naming the combination after a species, and presenting it as a new optimizer.
4. Do not add complexity to look sophisticated or algorithmic. A mechanism that does not outperform a simple alternative or baseline and offers no other clear benefit is not a contribution.
